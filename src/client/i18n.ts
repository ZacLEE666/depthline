...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    openedWorkspace: "Codex is opening this task.",
    ...
    refreshFailed: "The live connection is interrupted. Visible statuses may be stale.",
    ...
    reviewBatch: "Completed · awaiting review",
  ...
  "zh-CN": {
    ...
    openInCodex: "在 Codex 打开",
    openingCodex: "正在打开…",
    openedWorkspace: "正在 Codex 中打开对应任务。",
    ...
    refreshFailed: "实时连接已中断，当前显示的状态可能不是最新状态。",
    actionFailed: "操作未能完成。",
